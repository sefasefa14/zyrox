...
exports.run = async (bot, msg, args) => {
        ...
        userinfo.id = user.id;
        userinfo.od1 = msg.guild.members.get(user.id).user.presence.game || "Oynadığı bir oyun yok <a:zyroxcarpi:768471338590535770"
        ...
        userinfo.sonmesaj = user.lastMessage || "Son yazılan mesaj bulunamadı. <a:zyroxcarpi:768471338590535770" || "Son yazılan mesaj gösterilemedi. <a:zyroxcarpi:768471338590535770"
        ...
        .setFooter(`ZyRox Kullanıcı Bilgi Sistemi`)
