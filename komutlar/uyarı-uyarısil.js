...
exports.run = (client, message, args) => {
  ...
  if (!message.member.hasPermission("MANAGE_MESSAGES")) return message.reply(`<a:zyroxcarpi:768471338590535770> Bu komutu kullanabilmek için **Mesajları Yönet** iznine sahip olmalısın!`);
