...
exports.run = async (bot, message, args) => {
  ...
  if (!message.member.hasPermission('MANAGE_GUILD')) return message.channel.send('<a:zyroxcarpi:768471338590535770> Bu komudu kullanabilmek için `Sunucuyu Yönet` yetkisine sahip olmalısın!')
  if (!args[0]) return message.channel.send('<a:zyroxcarpi:768471338590535770> Sa-as yazısını açmak için; `z!sa-as aç veya kapat`')
