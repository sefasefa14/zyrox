...
exports.run = async (bot, message, args) => {
    ...
    if (!message.member.hasPermission('ADMINISTRATOR'))
        return message.channel.send('**<a:zyroxcarpi:768471338590535770> Bu komudu kullanabilmek için `Yönetici` yetkisine sahip olmalısın!**')
  
    if (!args[0]) return message.channel.send('**Sistemi kullanabilmek için** z!reklam-kick (aç-kapat)')
