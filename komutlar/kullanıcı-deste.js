...
exports.run = (client, message) => {
    let zulapng = "https://cdn.idcgames.com/Zula/Patchnotes/123/Red%20Skin%20Guaranteed%20Deck.png"
    ...
    .setImage("https://upload.wikimedia.org/wikipedia/commons/e/ec/Zula_New_LOGO_VECTOR.png")
    .setAuthor('ZyRox', zulapng)
    .setDescription(`${destedencikanlar}`)
    .setFooter(`Desteyi açan ${message.author.tag} Unutma Bunlar Sadece Bir Simülatör Gerçek hesabına Gelmez`)
    .setColor("#8470ff")
